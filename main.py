# main.py
# Core models, DB, scraper & shared config

# --- SQLite compatibility for Chroma ---
...
# LangChain compat imports (only Document needed here)
try:
...
class WebScraper:
    ...
    def scrape_website(
        self, base_url: str, max_pages: int = 40, 
        ...
        from langchain_text_splitters import RecursiveCharacterTextSplitter  # only used indirectly via docs? (kept for safety)
        documents = []
...
ANSWER (2-5 sentences):"""
    ...
    def ask(self, question: str, chat_history: List = None, session_id: str = None) -> str:
        ...
        try:
            ...
            import traceback
            traceback.print_exc()
            return "⚠️ An error occurred. Please try again or reload the page."
...
# CREATE PAGE
    ...
    with st.form("create_form", clear_on_submit=False):
        ...
        st.caption("⏱ This process may take 2-5 minutes depending on website size")
