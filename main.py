...
                return " Chatbot not properly initialized. Please try reloading."
            
...
            import traceback
            traceback.print_exc()
            return f" An error occurred. Please try again or reload the page."
    
...
                    if not st.session_state.ai_instance:
                        answer = " Chatbot disconnected. Please reload the page."
                    else:
