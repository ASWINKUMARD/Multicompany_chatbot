...
Original file is located at
    https://colab.research.google.com/drive/12WFJpJUr9F4iaZDOP33r9lJ-Ub1WSjwy
"""

# ============================================================================
# READY-MADE CHATBOT GENERATOR - PART 1: BACKEND & CORE SYSTEM
# ============================================================================
# This system allows automatic chatbot creation for any company by providing
# just their company name and website URL.
# ============================================================================
...
class Company(Base):
    ...
    scraping_status = Column(String(50), default="pending")  # pending, processing, completed, failed
...
MODEL = "google/gemini-2.0-flash-exp:free"  # Free model for cost efficiency
...
class WebScraper:
    """Handles web scraping for company websites"""
    ...
    def extract_content(self, soup: BeautifulSoup, url: str) -> Dict:
        ...
        try:
            ...
            for selector in content_selectors:
                main_parts.extend(soup.select(selector))
    ...
    def scrape_website(self, base_url: str, max_pages: int = 40,
        ...
        """
        Scrape website and return formatted content + company info
        Returns: (formatted_content, company_info_dict)
        """
        visited = set()
        all_content = []
        queue = deque()
        ...
        while queue and len(visited) < max_pages:
            ...
            try:
                ...
                if len(content_data['main_content']) > 100:
                    formatted = f"URL: {content_data['url']}\n"
                    formatted += f"TITLE: {content_data['title']}\n"

                    if "description" in content_data['metadata']:
                        formatted += f"DESCRIPTION: {content_data['metadata']['description']}\n"
